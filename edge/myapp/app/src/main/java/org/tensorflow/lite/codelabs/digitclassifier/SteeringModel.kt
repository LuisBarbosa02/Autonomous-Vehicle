...
class SteeringModel(private val context: Context) {
  ...
  private fun initializeInterpreter() {
    ...
    val model = loadModelFile(assetManager, "steering_model.tflite")
  ...
  private fun classify(bitmap: Bitmap): String {
    ...
    val steering = output[0][0]

    return "Steering: %.4f".format(steering)
  }
